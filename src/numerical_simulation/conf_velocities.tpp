...
void configuration<particle>::generate_MBvelocities( double mean_square_velocity ) {   //MD  // mean_square_velocity is intended as single (x) component mean square
  ...
  cout << " Velocities have been generated according to a Maxwell-Boltzmann distribution" << endl ;
  cout << "   Velocity of center of mass (System units): " << CoM_velocity.dump_position_variables() << endl ;
  cout << "   Total angular momentum (System units): " << total_angMomentum << endl ;
}
/****************************************************************************************/
...
void configuration<particle>::generate_velocities_by_file( void ) {   //MD
  ...
  CoM_velocity = compute_mean_velocity() ;
  total_angMomentum = compute_CoM_angular_momentum() ;
  cout << " Velocities have been read by file : \"" << velocities_file_name << "\"" << endl ;
  cout << "   Velocity of center of mass (System units): " << CoM_velocity.position << endl ;
  cout << "   Total angular momentum (System units): " << total_angMomentum << endl ;
}
/****************************************************************************************/
