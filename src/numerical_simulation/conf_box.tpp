...
inline void configuration<particle>::nearest_image( particle_3D *jptr , particle_3D *iptr , particle_3D *copy ) {
...
template <typename particle>
inline void configuration<particle>::nearest_image( particle_2D *jptr , particle_2D *iptr , particle_2D *copy ) {
  double dx = jptr->position.x - iptr->position.x ;
  double dy = jptr->position.y - iptr->position.y ;
